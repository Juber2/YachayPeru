...
{
    public class EditNoticiaHandler : IRequestHandler<EditNoticiaCommand, Result>
    {
        private readonly INoticiaRepository repository;
        private readonly IUnitOfWork unitOfWork;
        private readonly ICurrentUser currentUser;

        public EditNoticiaHandler(INoticiaRepository _repository, IUnitOfWork _unitOfWork, ICurrentUser _currentUser)
        {
        ...
        public async Task<Result> Handle(EditNoticiaCommand request, CancellationToken ct)
        {
            ...
            noticia.Category = request.Category;
            noticia.Body = request.Body;
            noticia.IsActive = request.IsActive;
